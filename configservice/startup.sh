...
export JAVA_OPTS="$JAVA_OPTS -Deureka.instance.ip-address=$HOST_IP -Deureka.instance.prefer-ip-address=true -Dserver.port=$SERVER_PORT -Dlogging.file=$LOG_DIR/$SERVICE_NAME.log -XX:HeapDumpPath=$LOG_DIR/HeapDumpOnOutOfMemoryError/"
